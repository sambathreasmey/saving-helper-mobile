...
class ThemeController extends GetxController {
  ...
  final List<ThemeDataModel> themes = [
    ...
    // ThemeDataModel(themePath: 'assets/images/couple_07.png', firstControlColor: Colors.white, secondControlColor: Colors.blueAccent, textColor: Colors.white),
    // ThemeDataModel(themePath: 'assets/images/couple_08.png', firstControlColor: Colors.white, secondControlColor: Colors.blueAccent, textColor: Colors.white),
    // ThemeDataModel(themePath: 'assets/images/couple_09.png', firstControlColor: Colors.white, secondControlColor: Colors.blueAccent, textColor: Colors.white),
    // ThemeDataModel(themePath: 'assets/images/couple_10.png', firstControlColor: Colors.white, secondControlColor: Colors.blueAccent, textColor: Colors.white),
  ];
