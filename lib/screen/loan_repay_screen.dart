...
class LoanRepayScreen extends StatefulWidget {
  const LoanRepayScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _LoanRepayScreenState createState() => _LoanRepayScreenState();
}

class _LoanRepayScreenState extends State<LoanRepayScreen> {
